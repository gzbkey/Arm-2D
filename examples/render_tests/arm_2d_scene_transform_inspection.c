...
#define __USER_SCENE_TRANSFORM_INSPECTION_IMPLEMENT__
...
static void __on_scene_transform_inspection_load(arm_2d_scene_t *ptScene)
{
...
static void __on_scene_transform_inspection_depose(arm_2d_scene_t *ptScene)
{
    user_scene_transform_inspection_t *ptThis = (user_scene_transform_inspection_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
/*----------------------------------------------------------------------------*
 * Scene transform_inspection                                                                    *
 *----------------------------------------------------------------------------*/
#if 0  /* deprecated */
static void __on_scene_transform_inspection_background_start(arm_2d_scene_t *ptScene)
{
    user_scene_transform_inspection_t *ptThis = (user_scene_transform_inspection_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static void __on_scene_transform_inspection_background_complete(arm_2d_scene_t *ptScene)
{
    user_scene_transform_inspection_t *ptThis = (user_scene_transform_inspection_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static void __on_scene_transform_inspection_frame_start(arm_2d_scene_t *ptScene)
{
    user_scene_transform_inspection_t *ptThis = (user_scene_transform_inspection_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static
IMPL_PFB_ON_DRAW(__pfb_draw_scene_transform_inspection_handler)
{
    ARM_2D_PARAM(pTarget);
    ARM_2D_PARAM(ptTile);
    ARM_2D_PARAM(bIsNewFrame);

    user_scene_transform_inspection_t *ptThis = (user_scene_transform_inspection_t *)pTarget;
...
ARM_NONNULL(1)
user_scene_transform_inspection_t *__arm_2d_scene_transform_inspection_init(   arm_2d_scene_player_t *ptDispAdapter, 
                                        user_scene_transform_inspection_t *ptThis)
{
    ...
    if (NULL == ptThis) {
        ptThis = (user_scene_transform_inspection_t *)
                    __arm_2d_allocate_scratch_memory(   sizeof(user_scene_transform_inspection_t),
                                                        __alignof__(user_scene_transform_inspection_t),
    ...
    memset(ptThis, 0, sizeof(user_scene_transform_inspection_t));
    ...
    *ptThis = (user_scene_transform_inspection_t){
        .use_as__arm_2d_scene_t = {
             ...
             */
            .fnOnLoad       = &__on_scene_transform_inspection_load,
            .fnScene        = &__pfb_draw_scene_transform_inspection_handler,
            .fnAfterSwitch  = &__after_scene_transform_inspection_switching,

            /* if you want to use predefined dirty region list, please uncomment the following code */
            //.ptDirtyRegion  = (arm_2d_region_list_item_t *)s_tDirtyRegions,
            
            //.fnOnBGStart    = &__on_scene_transform_inspection_background_start,        /* deprecated */
            //.fnOnBGComplete = &__on_scene_transform_inspection_background_complete,     /* deprecated */
            .fnOnFrameStart = &__on_scene_transform_inspection_frame_start,
            .fnBeforeSwitchOut = &__before_scene_transform_inspection_switching_out,
